//Write a program to input electricity unit consumed and find out the total charges according to following condition
...
int main()
{
	...
	cout<<"Your electricity charge is "<<charge<<endl;
